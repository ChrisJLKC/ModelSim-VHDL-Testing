...
BEGIN
	...
	BEGIN
		...
		-- Then Summing the two values together (00000001 and 00000001):
		SEL_SUM <= "00";
		SEL_ACC <= "11";
		EN_ACC <= '1';
		WAIT UNTIL RISING_EDGE(CLK);
		...
		-- Then Summing the two values together (10000000 and 00000010):
		SEL_SUM <= "00";
		SEL_ACC <= "11";
		WAIT UNTIL RISING_EDGE(CLK);
		...
		-- Then Summing the two values together (01000000 and 10000010):
		SEL_SUM <= "00";
		SEL_ACC <= "11";
		WAIT UNTIL RISING_EDGE(CLK);
		...
		-- Then Summing the two values together (00000001 and 11000010):
		SEL_SUM <= "00";
		SEL_ACC <= "11";
		WAIT UNTIL RISING_EDGE(CLK);
		...
		-- Then Summing the two values together (00100000 and 01000011):
		SEL_SUM <= "00";
		SEL_ACC <= "11";
		WAIT UNTIL RISING_EDGE(CLK);
		EN_ACC <= '0';
		...
		ASSERT ((ACC = "11100011") and (R1 = "00100000") and (R2 = "01000000"))
